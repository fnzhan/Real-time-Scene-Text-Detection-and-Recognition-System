...
trainroot_path = '/home/fnzhan/datasets/lmdb/train/IIIT5K'
#trainroot_path = '/export/home/frankzhan/projects/text_reco/crnn/dataset'
valroot_path = '/home/fnzhan/datasets/lmdb/train/IIIT5K'
crnn_path = '/home/fnzhan/projects/end_to_end/crnn/samples/crnn.pth'
#crnn_path = ''
experiment_path = '/home/fnzhan/projects/end_to_end/crnn/samples'
...
parser.add_argument('--valInterval', type=int, default=2500, help='Interval to be displayed')
parser.add_argument('--saveInterval', type=int, default=2500, help='Interval to be displayed')
...
train_loader = torch.utils.data.DataLoader(
    ...
    shuffle=False, sampler=sampler_mode,
...
if opt.crnn != '':
    ...
    crnn.load_state_dict(torch.load(opt.crnn, map_location=lambda storage, loc:storage))
...
for epoch in range(opt.niter):
	...
	crnn.train()
        ...
        if i % opt.saveInterval == 0:
            torch.save(
                crnn.state_dict(), '{0}/test.pth'.format(opt.experiment))
