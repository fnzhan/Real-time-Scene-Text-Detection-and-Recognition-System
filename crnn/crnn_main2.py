...
trainroot_path = '/export/home/frankzhan/datasets/lmdb/train/all'
#trainroot_path = '/export/home/frankzhan/projects/text_reco/crnn/dataset'
valroot_path = '/export/home/frankzhan/datasets/lmdb/test/stv2k'
crnn_path = '/export/home/frankzhan/projects/text_reco_2500/crnn/samples/CRNN_icdar_stv2k.pth'
...
parser.add_argument('--saveInterval', type=int, default=3000, help='Interval to be displayed')
...
for epoch in range(opt.niter):
	...
	crnn.train()
        ...
        if i % opt.saveInterval == 0:
            torch.save(
                crnn.state_dict(), '{0}/CRNN1_icdar_stv2k.pth'.format(opt.experiment))
